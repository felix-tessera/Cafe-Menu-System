            ...
            child: ListView(
              children: const [
                ...
                ManualItemWidget(
                  ...
                  manualBody:
                      '\nПод списком категорий находится еще один значок плюса, нажав на который в списке блюд появится новое пустое блюдо. Нажимая на его компоненты можно изменять. Наример, нажмите на цену блюда для ее изменения.',
                ),
                ManualItemWidget(
                ...
                ManualItemWidget(
                  ...
                  manualBody:
                      '\nДля удаления блюда нажмите три точки в правом нижнем углу блюда. После открытия меню, выберите пункт "Удаление блюда"',
                ),
                ManualItemWidget(
